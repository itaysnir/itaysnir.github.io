...
Where `#bar` is a stringify operator, and `\()` is concatenation operator. We can learn more about assembly-level macro directives within [this link][assembly-macros].
