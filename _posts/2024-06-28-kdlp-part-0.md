...
I've also made few configurations. Notice `dnf` stands for fedora's package manager. 
...
Designed to be pretty robust, as well as secured against memory corruptions. 
